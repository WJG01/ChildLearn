...
<body>
    <section class="top-nav-bar" style="z-index:50;" id="top-nav-bar">
        <div class="left-nav" id="left-nav">
            ...
            <nav>
                <ul class="main-menu">
                    <li><a href="student-course-quiz.php" name="all_quiz">Courses <i class="fas fa-caret-down"></i></a>
                        <ul class="sub-menu" style="z-index:50;">
                            <li><a href="show-course.php?cat=Language and Literacy">Language and Literacy Course</a></li>
                            <li><a href="show-course.php?cat=Mathematics and Logic">Mathematics and Logic Course</a></li>
                            <li><a href="show-course.php?cat=Science and Discovery">Science and Discovery Course</a></li>
                        </ul>
                    </li>

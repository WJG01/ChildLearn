...
if (isset($_POST['update-course'])) {
  ...
  if (isset($_FILES['image'])) {
    ...
    if ($uploadResult) {
      ...
      $udpate_image = ", course_cover = '" . basename($uploadedFile['name']) . "'";
    } else {
      echo 'File upload failed.';
    }
  }

  $query = "UPDATE course SET course_title='$title', course_category='$category', course_description='$description' $udpate_image WHERE course_id='$id'";

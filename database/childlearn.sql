...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 30, 2023 at 04:50 PM
...
(1, 'Phonics Fun', 'Language and Literacy', 'Phonics Fun.jpeg', 'This course introduces children to phonics through interactive games, songs, and activities.', '2023-06-30', 1),
(2, 'Storytelling Adventures', 'Language and Literacy', 'Storytelling Adventures.jpeg', 'In this course, children embark on exciting storytelling adventures. They learn how to create characters, build narratives, and express their ideas through storytelling techniques, encouraging creativity and language development.', '2023-06-30', 1),
(3, 'Word Wizards', 'Language and Literacy', 'Word Wizards.jpeg', 'Word Wizards is a vocabulary-building course that helps children expand their word bank, improve word usage, and enhance their language skills through engaging word games, puzzles, and word association activities.', '2023-06-30', 1),
(4, 'Number Ninjas', 'Mathematics and Logic', 'Number Ninjas.jpeg', 'Number Ninjas is a course designed to develop children\'s number sense and counting skills. Through interactive exercises, games, and counting adventures, children learn to recognize numbers, count objects, and understand basic mathematical concepts.', '2023-06-30', 2),
(5, 'Shape Explorers', 'Mathematics and Logic', 'Shape Explorers.jpeg', 'Shape Explorers takes children on a journey to discover different shapes and patterns. Through hands-on activities, shape recognition games, and pattern-building challenges, children develop spatial awareness and logical thinking skills.', '2023-06-30', 2),
(6, 'Problem Solvers Club', 'Mathematics and Logic', 'Problem Solvers Club.jpeg', 'In the Problem Solvers Club, children are introduced to critical thinking and problem-solving skills. Through puzzles, riddles, and interactive challenges, they learn to analyze situations, make decisions, and find solutions using their mathematical abili', '2023-06-30', 2),
(7, 'Nature Detectives', 'Science and Discovery', 'Nature Detectives.jpeg', 'Nature Detectives is an exploration course that helps children discover the wonders of nature. Through interactive lessons, virtual field trips, and nature-themed activities, children learn about plants, animals, ecosystems, and develop an appreciation fo', '2023-06-30', 3),
(8, 'Science Lab Explorers', 'Science and Discovery', 'Science Lab Explorers.jpeg', 'Science Lab Explorers takes children on a virtual journey to the science lab. Through hands-on experiments, demonstrations, and scientific investigations, children explore basic scientific concepts, such as states of matter, electricity, or simple chemica', '2023-06-30', 3),
(9, 'STEM Builders', 'Science and Discovery', 'STEM Builders.jpeg', 'STEM Builders is a course that introduces children to the exciting world of STEM. Through engaging projects, experiments, and interactive challenges, children develop critical thinking, problem-solving, and engineering skills while exploring topics like r', '2023-06-30', 3);
...
INSERT INTO `course_chapter` (`chapter_id`, `chapter_title`, `content_text`, `content_image`, `content_video`, `course_id`) VALUES
(1, 'Letter Magic', 'Chapter 1 teaching content paragraph 1...', 'Letter Magic.jpeg', 'Letter Magic.mp4', 1),
(2, 'Sound Detectives', 'Chapter 2 teaching content paragraph 1...', 'Sound Detectives.jpeg', 'Sound Detectives.mp4', 1),
(3, 'Reading Adventures', 'Chapter 3 teaching content paragraph 1...', 'Reading Adventures.jpeg', 'Reading Adventures.mp4', 1),
(4, 'Creating Characters', 'Chapter 1 teaching content paragraph 1...', 'Creating Characters.jpeg', 'Creating Characters.mp4', 2),
(5, 'Building Plotlines', 'Chapter 2 teaching content paragraph 1...', 'Building Plotlines.jpeg', 'Building Plotlines.mp4', 2),
(6, 'Expressive Storytelling', 'Chapter 3 teaching content paragraph 1...', 'Expressive Storytelling.jpeg', 'Expressive Storytelling.mp4', 2),
(7, 'Vocabulary Voyage', 'Chapter 1 teaching content paragraph 1...', 'Vocabulary Voyage.jpeg', 'Vocabulary Voyage.mp4', 3),
(8, 'Word Puzzles Galore', 'Chapter 2 teaching content paragraph 1...', 'Word Puzzles Galore.jpeg', 'Word Puzzles Galore.mp4', 3),
(9, 'Creative Word Play', 'Chapter 3 teaching content paragraph 1...', 'Creative Word Play.jpeg', 'Creative Word Play.mp4', 3),
(10, 'Counting Conquerors', 'Chapter 1 teaching content paragraph 1...', 'Counting Conquerors.jpeg', 'Counting Conquerors.mp4', 4),
(11, 'Addition Adventures', 'Chapter 2 teaching content paragraph 1...', 'Addition Adventures.jpeg', 'Addition Adventures.mp4', 4),
(12, 'Subtraction Superstars', 'Chapter 3 teaching content paragraph 1...', 'Subtraction Superstars.jpeg', 'Subtraction Superstars.mp4', 4),
(13, 'Exploring 2D Shapes', 'Chapter 1 teaching content paragraph 1...', 'Exploring 2D Shapes.jpeg', 'Exploring 2D Shapes.mp4', 5),
(14, 'Discovering 3D Shapes', 'Chapter 2 teaching content paragraph 1...', 'Discovering 3D Shapes.jpeg', 'Discovering 3D Shapes.mp4', 5),
(15, 'Pattern Puzzlers', 'Chapter 3 teaching content paragraph 1...', 'Pattern Puzzlers.jpeg', 'Pattern Puzzlers.mp4', 5),
(16, 'Logic Labyrinth', 'Chapter 1 teaching content paragraph 1...', 'Logic Labyrinth.jpeg', 'Logic Labyrinth.mp4', 6),
(17, 'Critical Thinking Challenges', 'Chapter 2 teaching content paragraph 1...', 'Critical Thinking Challenges.jpeg', 'Critical Thinking Challenges.mp4', 6),
(18, 'Puzzle Solvers Society', 'Chapter 3 teaching content paragraph 1...', 'Puzzle Solvers Society.jpeg', 'Puzzle Solvers Society.mp4', 6),
(19, 'Plants and Their World', 'Chapter 1 teaching content paragraph 1...', 'Plants and Their World.jpeg', 'Plants and Their World.mp4', 7),
(20, 'Animal Kingdom Explorations', 'Chapter 2 teaching content paragraph 1...', 'Animal Kingdom Explorations.jpeg', 'Animal Kingdom Explorations.mp4', 7),
(21, 'Ecosystem Expeditions', 'Chapter 3 teaching content paragraph 1...', 'Ecosystem Expeditions.jpeg', 'Ecosystem Expeditions.mp4', 7),
(22, 'States of Matter Exploration', 'Chapter 1 teaching content paragraph 1...', 'States of Matter Exploration.jpeg', 'States of Matter Exploration.mp4', 8),
(23, 'Electricity and Circuitry Adventures', 'Chapter 2 teaching content paragraph 1...', 'Electricity and Circuitry Adventures.jpeg', 'Electricity and Circuitry Adventures.mp4', 8),
(24, 'Chemical Reactions Unveiled', 'Chapter 3 teaching content paragraph 1...', 'Chemical Reactions Unveiled.jpeg', 'Chemical Reactions Unveiled.mp4', 8),
(25, 'Introduction to Robotics', 'Chapter 1 teaching content paragraph 1...', 'Introduction to Robotics.jpeg', 'Introduction to Robotics.mp4', 9),
(26, 'Building Simple Machines', 'Chapter 2 teaching content paragraph 1...', 'Building Simple Machines.jpeg', 'Building Simple Machines.mp4', 9),
(27, 'Coding Adventures', 'Chapter 3 teaching content paragraph 1...', 'Coding Adventures.jpeg', 'Coding Adventures.mp4', 9);

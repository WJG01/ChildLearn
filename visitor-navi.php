        ...
        <div class="left-nav" id="left-nav">
            ...
            <nav>
                <ul class="main-menu">
                    ...
                    <li><a href="https://childlearn-bucket.s3.amazonaws.com/aboutus/visitor-faq.html" target="_blank">FAQ</a></li>
                    <li><a href="https://childlearn-bucket.s3.amazonaws.com/aboutus/visitor-aboutus.html" target="_blank">About Us</a></li>
                </ul>
            </nav>
        </div>
